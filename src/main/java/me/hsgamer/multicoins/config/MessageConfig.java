...
public class MessageConfig extends PathableConfig {
    ...
    public static final StringConfigPath GIVE_SUCCESS = new StringConfigPath("give-success", "&aSuccessfully given {value} {currency} to {player}!");
    public static final StringConfigPath GIVE_FAILED = new StringConfigPath("give-failed", "&cFailed to give {value} {currency} to {player}!");
    public static final StringConfigPath TAKE_SUCCESS = new StringConfigPath("take-success", "&aSuccessfully taken {value} {currency} from {player}!");
    public static final StringConfigPath TAKE_FAILED = new StringConfigPath("take-failed", "&cFailed to take {value} {currency} from {player}!");
    public static final StringConfigPath SET_SUCCESS = new StringConfigPath("set-success", "&aSuccessfully set {value} {currency} to {player}!");
    public static final StringConfigPath SET_FAILED = new StringConfigPath("set-failed", "&cFailed to set {value} {currency} to {player}!");
